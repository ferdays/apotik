...
<body>
    ...
    <div class="container-fluid" id="atas">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel-statistik-big" style="height:130px;background:#A9D86E;padding:10px;text-align:center;">
                    <h1 style='color:#FFF;font-weight:300;'>Lihat Data</h1>
                    <p style='color:#FFF;font-weight:300;'>Data Obat</p>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 fade-in">
                <div class="panel">
                    <div class="panel-heading">
                        <p style='margin:0;'><i class='fa fa-archive'></i> Data Obat</p>
                    ...
                    <div class="alert alert-dismissible alert-success">
                      ...
                      <strong>Sukses!</strong> Menghapus data obat.
                    </div>
                    <?php
                    } else if($_GET['info'] == '3')
                    {
                    ...
                    <div class="alert alert-dismissible alert-success">
                        <button type="button" class="close" data-dismiss="alert"><i class='fa fa-close'></i></button>
                        <strong>Sukses!</strong> Anda sukses memperbarui data obat
                    </div>
                    <?php
                    }
                    }
                    ...
                    <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                ?>
                                <th colspan="5" class='text-right'>Total Stok Obat</th>
                                <th><?php echo $dataobat['SUM(stok)']; ?></th>
                                <th></th>
                                <th></th>
                            </tr>
                        </tfoot>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>Rp. <?php $jual = number_format($data['harga_jual'],2,",","."); echo $jual; ?></td>
                                <td><?php if ($data['stok']==null) { echo "0"; } else { echo $data['stok']; }?></td>
                                <td><?php if ($data['resep']==1) { echo "Menggunakan Resep Dokter"; } else { echo "Tanpa Resep Dokter"; }?></td>
                                <td><?php echo $data['kadaluarsa']; ?></td>
                                <td class='text-center'>
                                    <a href="#" class="edit-record" data-id="<?php echo $data['id_obat']; ?>"><span class="label label-warning"><i class='fa fa-edit' data-toggle="tooltip" data-placement="top" data-original-title="Edit"></i></span></a>
                                    <a href="#" data-toggle="modal" data-target="#myModal" data-href="../system/delete-obat.php?id=<?php echo $data['id_obat']; ?>"><span class="label label-danger"><i class='fa fa-remove' data-toggle="tooltip" data-placement="top" data-original-title="Hapus"></i></span></a>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
