...
if ($jabatan!="admin" && $jabatan!="gudang") {
    header("Location: ../");
}
else {
?>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel-statistik-big" style="height:130px;background:#00A8B3;padding:10px;text-align:center;">
                    ...
                    <p style='color:#FFF;font-weight:300;'>Data Pemasok</p>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 fade-in">
                <div class="panel">
                    <div class="panel-heading">
                        <p style='margin:0;'><i class='fa fa-users'></i> Data Pemasok</p>
                    ...
                    <div class="alert alert-dismissible alert-success">
                      ...
                      <strong>Sukses!</strong> Menghapus pemasok.
                    </div>
                    <?php 
                    }
                    }
                    ...
                    <table class="table table-hover table-bordered results" style='text-transform:capitalize;'>
                      <thead>
                        <tr>
                          ...
                          <th class="col-md-2 col-xs-2">Telepon</th>
                          <th class="col-md-2 col-xs-2">Aksi</th>
                        </tr>
                        <tr class="danger no-result">
                          <td colspan="5"><i class="fa fa-warning"></i> Tidak ada hasil</td>
                        </tr>
                      </thead>
                      <tbody>
                        <?php 
                        $listuser = mysql_query("SELECT * FROM supplier");
                        $no = 1;
                        ...
                        <tr>
                          ...
                          <td class='text-center'>
                            ...
                            <a href="#" class="edit-record" data-id="<?php echo $data['id_supplier']; ?>"><span class="label label-warning"><i class='fa fa-edit' data-toggle="tooltip" data-placement="top" data-original-title="Edit"></i></span></a>
                            <a href="#" data-toggle="modal" data-target="#myModal" data-href="../system/delete-supplier.php?id=<?php echo $data['id_supplier']; ?>"><span class="label label-danger"><i class='fa fa-remove' data-toggle="tooltip" data-placement="top" data-original-title="Hapus"></i></span></a>
                            <?php } $no++; } ?>
                          </td>
                        </tr>
                      </tbody>
