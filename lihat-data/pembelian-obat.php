        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel-statistik-big" style="height:130px;background:#8175C7;padding:10px;text-align:center;">
                    ...
                    <p style='color:#FFF;font-weight:300;'>Data Pembelian Obat</p>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 fade-in">
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <p style='margin:0;'><i class='fa fa-line-chart'></i> Data Pembelian Obat</p>
                    ...
                    <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            <?php
                            $dataobat = mysql_query("SELECT * FROM pembelian ORDER BY id_pembelian DESC");
                            $no=1;
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    $getsupplier = mysql_query("SELECT * FROM supplier WHERE id_supplier='$supplier'");
                                    $get = mysql_fetch_array($getsupplier);
                                    echo $get["nama"]; 
                                    ?>
                                </td>
                                <td>
                                    ...
                                    $getjumlah = mysql_query("SELECT SUM(jumlah) FROM faktur_pembelian WHERE no_faktur='$nofaktur'");
                                ...
                                <td>
                                    <?php
                                    $gettanggal = mysql_query("SELECT * FROM faktur_pembelian WHERE no_faktur='$nofaktur'");
                                    $tanggal = mysql_fetch_array($gettanggal);
                                    echo $tanggal['tanggal'];
                                    ?>
                                </td>
                                <td>Rp. <?php $total = number_format($data['total'],2,",","."); echo $total;  ?></td>
                                <td class='text-center'>
                                    <a href="detail-pembelian-obat.php?nofaktur=<?php echo $nofaktur; ?>"><span class="label label-success"><i class='fa fa-search' data-toggle="tooltip" data-placement="top" data-original-title="Detail"></i></span></a>
                                    <a  href="javascript:void(0);"
                                        onclick="window.open('../print/print-detail-pembelian-obat.php?nofaktur=<?php echo $nofaktur; ?>','Print Preview','size=800,height=800,scrollbars=yes,resizeable=no')"><span class="label label-info"><i class='fa fa-print' data-toggle="tooltip" data-placement="top" data-original-title="Print"></i></span></a>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
