        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Data Penjualan Obat Resep</li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="panel-statistik-big" style="height:130px;background:#B984DC;padding:10px;text-align:center;">
                    ...
                    <p style='color:#FFF;font-weight:300;'>Data Penjualan Obat Resep</p>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 fade-in">
                <div class="panel panel-danger">
                    <div class="panel-heading">
                        <p style='margin:0;'><i class='fa fa-medkit'></i> Data Penjualan Obat Resep</p>
                    ...
                    <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            <?php
                            $datapenjualan = mysql_query("SELECT * FROM penjualan_resep ORDER BY id_penjualan_r DESC");
                            $no=1;
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                    $nofaktur = $data['no_resep'];
                                    $getjumlah = mysql_query("SELECT SUM(jumlah) FROM faktur_penjualan_resep WHERE no_resep='$nofaktur'");
                                    $jumlah = mysql_fetch_array($getjumlah);
                                    echo $jumlah['SUM(jumlah)'];
                                    ?> Obat
                                </td>
                                <td><?php echo $data['tanggal']; ?></td>
                                <td>Rp. <?php $total2 = number_format($data['total'],2,",","."); echo $total2; ?></td>
                                <td class='text-center'>
                                    <a href="detail-penjualan-obat-resep.php?nofaktur=<?php echo $nofaktur; ?>"><span class="label label-success"><i class='fa fa-search' data-toggle="tooltip" data-placement="top" data-original-title="Detail"></i></span></a>
                                    <a  href="javascript:void(0);"
                                        onclick="window.open('../print/struk.php?no_faktur=<?php echo $nofaktur; ?>','Print Preview','size=800,height=800,scrollbars=yes,resizeable=no')"><span class="label label-info"><i class='fa fa-print' data-toggle="tooltip" data-placement="top" data-original-title="Print"></i></span></a>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
