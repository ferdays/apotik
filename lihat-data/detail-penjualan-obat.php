        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="penjualan-obat.php">Data Penjualan Obat</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel-statistik-big" style="height:130px;background:#c0392b;padding:10px;text-align:center;">
                    ...
                    <p style='color:#FFF;font-weight:300;'>Detail Penjualan Obat / No. Faktur: <strong><?php echo $getnofaktur; ?></strong> / Pasien: <strong><?php $getpenjualan = mysql_fetch_array(mysql_query("SELECT * FROM penjualan WHERE no_faktur='$getnofaktur'")); echo $getpenjualan['namapasien']; ?></strong></p>
                </div>
                <?php 
                    if (!empty($_GET['info'])) {
                        if ($_GET['info']=="1") {
                ...
                <div class="alert alert-dismissible alert-success">
                    ...
                    <strong>Sukses!</strong> Menjual obat.
                </div>
                <?php } } ?>
            </div>
        ...
        <div class="row">
                    ...
                    <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th>
                                    Rp. <?php 
                                    $gettotal = mysql_fetch_array(mysql_query("SELECT * FROM penjualan WHERE no_faktur='$getnofaktur'"));
                        ...
                        <tbody>
                            <?php
                            $dataobat = mysql_query("SELECT * FROM faktur_penjualan WHERE no_faktur='$getnofaktur'");
                            $no=1;
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                    $datadokter = mysql_fetch_array(mysql_query("SELECT * FROM penjualan WHERE no_faktur='$getnofaktur'"));
                                    if ($data['resep']==0) {
                                        echo "Tanpa Dokter";
                                    }
                                    elseif ($data['resep']==1) {
                                ...
                                <td>Rp. <?php $harga = number_format($data['harga'],2,",","."); echo $harga; ?></td>
            ...
            <div class="col-md-2">
                <a  href="javascript:void(0);"
                    onclick="window.open('../print/bon.php?no_faktur=<?php echo $getnofaktur; ?>','Print Preview','size=800,height=800,scrollbars=yes,resizeable=no')" class='btn btn-info' style='width:100%;margin-bottom:20px;'><i class='fa fa-print'></i> Print</a>
            </div>
        </div>
    </div>
    <footer>
