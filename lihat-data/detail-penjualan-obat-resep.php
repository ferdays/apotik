...
<body>
    ...
    <div class="container-fluid" id="atas">
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="penjualan-obat-resep.php">Data Penjualan Obat Resep</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel-statistik-big" style="height:130px;background:#B984DC;padding:10px;text-align:center;">
                    <h1 style='color:#FFF;font-weight:300;'>Lihat Data</h1>
                    <p style='color:#FFF;font-weight:300;'>Detail Penjualan Obat Resep / No. Resep:
                        <strong><?php echo $getnofaktur; ?>
                        </strong>
                        Oleh Dokter 
                        <strong>
                            <?php
                            $getiddokter = mysql_fetch_array(mysql_query("SELECT * FROM penjualan_resep WHERE no_resep='$getnofaktur'"));
                            $iddokter = $getiddokter['id_dokter'];
        ...
        <div class="row">
            <div class="col-md-10 fade-in">
                <div class="panel panel-danger">
                    <div class="panel-heading">
                        <p style='margin:0;'><i class='fa fa-line-chart'></i> Detail Penjualan Obat</p>
                    ...
                    <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th>
                                    Rp. <?php 
                                    $gettotal = mysql_fetch_array(mysql_query("SELECT * FROM penjualan_resep WHERE no_resep='$getnofaktur'"));
                                    $total2 = number_format($gettotal['total'],2,",","."); echo $total2;
                                     ?>
                                </th>
                            </tr>
                            <tr>
                                ...
                                <th>
                                    Rp. <?php
                                    $bayar = number_format($gettotal['bayar'],2,",","."); echo $bayar;
                                    ?>
                                </th>
                            </tr>
                            <tr>
                                ...
                                <th>
                                    Rp. <?php
                                    $kembalian = number_format($gettotal['kembalian'],2,",","."); echo $kembalian;
                                    ?>
                                </th>
                            </tr>
                        </tfoot>
                        <tbody>
                            <?php
                            $dataobat = mysql_query("SELECT * FROM faktur_penjualan_resep WHERE no_resep='$getnofaktur'");
                            $no=1;
                            ...
                            <tr>
                                ...
                                <td>Rp. <?php $harga = number_format($data['subtotal'],2,",","."); echo $harga; ?></td>
            ...
            <div class="col-md-2">
                <a  href="javascript:void(0);"
                    onclick="window.open('../print/struk.php?no_faktur=<?php echo $getnofaktur; ?>','Print Preview','size=800,height=800,scrollbars=yes,resizeable=no')" class='btn btn-info' style='width:100%;margin-bottom:20px;'><i class='fa fa-print'></i> Print</a>
            </div>
        </div>
    </div>
    <footer>
