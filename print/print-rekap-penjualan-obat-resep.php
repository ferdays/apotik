...
<body>
	<div id="div1">
		...
		<h3 class='text-center'>Rekap Penjualan Obat Menggunakan Resep Tahun 2016</h3>
		<br>
				...
				<tr>
					...
					<td class="text-center"><?php echo $obat['nama_obat']; ?></td>
						...
						<td class="text-center">
							<?php
								$idobat = $obat['id_obat'];
								$getbulan = mysql_query("SELECT SUM(jumlah) FROM faktur_penjualan_resep WHERE MONTH(tanggal)='$i' AND id_obat=$idobat");
					...
					<td class="text-center">
						<?php
							$getjumlah = mysql_query("SELECT SUM(jumlah) FROM faktur_penjualan_resep WHERE id_obat=$idobat");
