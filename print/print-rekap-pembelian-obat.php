...
<body>
	<div id="div1">
		...
		<h3 class='text-center'>Rekap Pembelian Obat Tahun 2016</h3>
		<br>
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th colspan="12" class="text-center">Jumlah Pembelian</th>
					<th rowspan="2" class="text-center" style="vertical-align:middle;">Total Pembelian</th>
					<tr>
				...
				<tr>
					...
					<td class="text-center"><?php echo $obat['nama_obat']; ?></td>
						...
						<td class="text-center">
							<?php
								$idobat = $obat['id_obat'];
								$getbulan = mysql_query("SELECT SUM(jumlah) FROM faktur_pembelian WHERE MONTH(tanggal)='$i' AND id_obat=$idobat");
					...
					<td class="text-center">
						<?php
							$getjumlah = mysql_query("SELECT SUM(jumlah) FROM faktur_pembelian WHERE id_obat=$idobat");
