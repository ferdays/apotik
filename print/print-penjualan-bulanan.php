...
<body>
	<div id="div1">
		...
		<h3 class='text-center'>Rekap Penjualan Obat Bulan <?php echo $namabulan[$bulan]; ?></h3>
		<br>
		<table class="table table-bordered">
			...
			<tbody>
				<?php
					$no = 1;
					$bulan2 = $bulan + 1;
					$getbulanan = mysql_query("SELECT * FROM faktur_penjualan WHERE MONTH(tanggal)=$bulan2 ORDER BY id_faktur_j DESC");
