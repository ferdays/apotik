...
<body>
    ...
    <div class="container-fluid" id="atas">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel-statistik-big" style="height:130px;background:#3498DB;padding:10px;text-align:center;">
                    <h1 style='color:#FFF;font-weight:300;'>Manajemen User</h1>
                    <p style='color:#FFF;font-weight:300;'>Tambah Pemasok Obat</p>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-7 fade-in">
                <div class="panel">
                    <div class="panel-heading">
                        <p style='margin:0;'><i class='fa fa-user-plus'></i> Tambah Pemasok</p>
                        <span class="tools pull-right">
                        <span class="pull-right clickable"><i class="fa fa-angle-up"></i></span>
                    </span>
                    </div>
                    <div class="panel-body profile-activity">
                    <form action="../system/add-suplier.php" method="POST" role="form">
                        ...
                        if(!empty($_GET['info'])) {
                               if($_GET['info'] == '1')
                                ...
                                <div class="alert alert-dismissible alert-success">
                                    ...
                                    <strong>Sukses!</strong> Anda sukses menambah pemasok baru
                                </div>
                                <?php }
                                elseif($_GET['info'] == '2')
                                {
